...
for page in range(page_min,page_max+1):
    ...
    for i in range(27,27+50):
        try:
            ...
            if str(sol_lang).strip()=="":
                p_tag = sol_time.next.next.next.next.next.next.next.next.next.next.next.next.next
                sol_lang = sol_time.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next
